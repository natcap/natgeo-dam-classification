        ...
        try:
            ...
            subprocess.call(
                ['./bin/azcopy', 'cp', clipped_gsw_tile_path,
                 "https://notadamimages.blob.core.windows.net/autogeneratedimages/?sv=2018-03-28&ss=bfqt&srt=sco&sp=rwdlacup&se=2020-08-20T08:31:49Z&st=2019-08-20T00:31:49Z&spr=https,http&sig=OFqddTC2deYQ1xcthvThhsL0grnWMYqoUW2hNQ2L3JQ%3D"])
            os.remove(clipped_gsw_tile_path)
